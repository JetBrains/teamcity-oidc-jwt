...
class OIDCTokenInParamsBuildFeatureControllerTest : BaseTestCase() {
    ...
    private lateinit var controller: OIDCTokenInParamsBuildFeatureController
    ...
    override fun setUp() {
        ...
        controller = OIDCTokenInParamsBuildFeatureController(descriptor, web, settings)
    }
    ...
    fun init_registersControllerAtCorrectPath() {
        verify { web.registerController(
            eq("${pluginResourcesPrefix}oidcTokenInParamsBuildFeature.html"),
            eq(controller)
        ) }
    }
    ...
    fun doHandle_usesCorrectJspView() {
        ...
        Assertions.assertThat(mv.viewName).isEqualTo("${pluginResourcesPrefix}oidcTokenInParamsBuildFeature.jsp")
    }
    ...
    fun doHandle_happyPath_populatesAllModelValues() {
        ...
        Assertions.assertThat(mv.model["defaultTimeoutSeconds"]).isEqualTo(600L)
    }
